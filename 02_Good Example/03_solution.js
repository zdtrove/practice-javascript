/**
 * We're building a voting application, where we present multiple options and allow users to click on different buttons, 
 * in a sense "makeing a vote". At the end, we would like to see how many votes each item received.
 * 
